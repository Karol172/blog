...
public class ArticlesManagmentController
{
  ...
  @RequestMapping(value={"/admin/categories"}, method={org.springframework.web.bind.annotation.RequestMethod.GET})
  ...
  @RequestMapping(value={"/admin/categories/add"}, method={org.springframework.web.bind.annotation.RequestMethod.GET})
  ...
  @RequestMapping(value={"/admin/categories/edit/{id}"}, method={org.springframework.web.bind.annotation.RequestMethod.GET})
  ...
  @RequestMapping(value={"/admin/categories/try_add"}, method={org.springframework.web.bind.annotation.RequestMethod.POST})
  public String categorySave(@ModelAttribute("categoryForm") @Valid CategoryDto categoryDto, BindingResult result, Model model, HttpServletRequest request)
  {
  ...
  @RequestMapping(value={"/admin/categories/remove/{id}"}, method={org.springframework.web.bind.annotation.RequestMethod.GET})
  ...
  @RequestMapping(value={"/admin/articles"}, method={org.springframework.web.bind.annotation.RequestMethod.GET})
  ...
  @RequestMapping(value={"/admin/article/add"}, method={org.springframework.web.bind.annotation.RequestMethod.GET})
  ...
  @RequestMapping(value={"/admin/article/edit/{id}"}, method={org.springframework.web.bind.annotation.RequestMethod.GET})
  ...
  @RequestMapping(value={"/admin/articles/try_add"}, method={org.springframework.web.bind.annotation.RequestMethod.POST})
  public String articleSave(@ModelAttribute("articleForm") @Valid ArticleForm articleForm, BindingResult result, Model model, HttpServletRequest request)
  {
    this.dataPageService.getDataPage(model, request);
  ...
  @RequestMapping(value={"/admin/article/remove/{id}"}, method={org.springframework.web.bind.annotation.RequestMethod.GET})
