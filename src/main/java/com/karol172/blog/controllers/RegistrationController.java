...
public class RegistrationController
{
  ...
  @RequestMapping(value={"/registration/try_register"}, method={org.springframework.web.bind.annotation.RequestMethod.POST})
  public String registerUser(@ModelAttribute("registrationUserForm") @Valid RegistrationUserForm registrationUserForm, BindingResult result, Model model, HttpServletRequest request)
  {
  ...
  @RequestMapping(value={"/registration/activation/{activationCode}"}, method={org.springframework.web.bind.annotation.RequestMethod.GET})
  public String activateAccount(@PathVariable("activationCode") String activationCode, Model model, HttpServletRequest request)
  {
