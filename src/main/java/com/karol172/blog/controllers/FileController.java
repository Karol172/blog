...
public class FileController {
  ...
  @RequestMapping(value="/admin/files/add", method=RequestMethod.POST)
  public String addFile(@ModelAttribute("fileForm") @Valid FileForm fileForm,
  ...
  @RequestMapping(value="/admin/files/remove/{id}", method=RequestMethod.GET)
