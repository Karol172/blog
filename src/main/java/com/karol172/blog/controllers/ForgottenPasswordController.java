...
public class ForgottenPasswordController
{
  ...
  @RequestMapping(value={"/forgotten/password"}, method={org.springframework.web.bind.annotation.RequestMethod.GET})
  ...
  @RequestMapping(value={"/forgotten/password/send"}, method={org.springframework.web.bind.annotation.RequestMethod.POST})
  public String reportForgottenPassword(@ModelAttribute("forgottenPasswordForm") @Valid ForgottenPasswordForm form, BindingResult result, Model model, HttpServletRequest request)
  {
    this.dataPageService.getDataPage(model, request);
  ...
  @RequestMapping(value={"/forgotten/password/change/{changeCode}"}, method={org.springframework.web.bind.annotation.RequestMethod.GET})
  ...
  @RequestMapping(value={"/forgotten/password/try_change"}, method={org.springframework.web.bind.annotation.RequestMethod.POST})
  public String changePassword(@ModelAttribute("changePasswordForm") ChangePasswordForm changePasswordForm, BindingResult result, Model model, HttpServletRequest request)
  {
