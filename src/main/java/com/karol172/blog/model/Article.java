...
public class Article {
    ...
    @JoinTable(name="authors_articles", joinColumns={@JoinColumn(name="article_id", referencedColumnName="id")},
    ...
    public Article(String title, String contents, String contentsMore, LocalDateTime additionDate,
                   LocalDateTime publicationDate, Boolean isActive, Boolean canComment, Category category) {
      this.title = title;
